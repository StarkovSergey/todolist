...
export const AddTodolist = () => {
  ...
  const addTodolist = () => {
    todolistAPI.addTodolist(title).then((response) => {
      setState(response.data)
      setTitle('')
    })
  }
...
export const RemoveTodolist = () => {
  ...
  const removeTodolist = () => {
    todolistAPI.removeTodolist(todolistID).then((response) => {
      setState(response.data)
      setTodolistID('')
    })
  }
...
export const ChangeTodolistTitle = () => {
  ...
  const changeTodolistTitle = () => {
    todolistAPI.changeTodolistTitle(todolistID, title).then((response) => {
...
export const AddTask = () => {
  ...
  const addTask = () => {
    todolistAPI.addTask(todolistID, title).then((response) => {
      setState(response.data)
      setTitle('')
      setTodolistID('')
    })
...
export const RemoveTask = () => {
  ...
  const removeTask = () => {
    todolistAPI.removeTask(todolistID, taskID).then((response) => {
      setState(response.data)
      setTaskID('')
      setTodolistID('')
    })
